...
import com.toast.android.gamebase.sample.ui.SplashActivity
...
class AppFlowHelper {
    companion object {
        ...
        fun savePushConfiguration(
            ...
            val pref =
                context.getSharedPreferences(com.toast.android.gamebase.sample.AppFlowHelper.Companion.PREFERENCE_NAME, Context.MODE_PRIVATE)
            val editor = pref.edit()
            editor.putString(
                com.toast.android.gamebase.sample.AppFlowHelper.Companion.PREF_KEY_PUSH_CONFIGURATION,
        ...
        fun showErrorAndReturnToTitle(activity: Activity, title: String, message: String) {
            val returnToTitle =
                DialogInterface.OnClickListener { dialog: DialogInterface?, which: Int ->
                    com.toast.android.gamebase.sample.AppFlowHelper.Companion.returnToTitle(
                        activity
                    )
                }
        ...
        fun returnToTitle(activity: Activity) {
            ...
            if (userId != null && !userId.isEmpty()) {
                ...
                com.toast.android.gamebase.sample.GamebaseManager.Companion.initialize(activity)
            }
        }
